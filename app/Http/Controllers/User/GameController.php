...
class GameController extends Controller
{
    ...
    public function add(AddGameToUserList $request)
    {
        ...
        // pobranie gry z katalogu, przy okazji będzie weryfikowanie, czy ta gra istnieje w systemie, żeby ktoś nie przesłał spreparowanych danych, ids

        // dodać grę do użytkownika przekazując obiektu
